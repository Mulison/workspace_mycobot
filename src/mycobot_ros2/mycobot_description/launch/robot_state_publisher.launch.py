...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.abspath(os.path.join(
        home,
        'Documents/workspace_mycobot/src/mycobot_ros2/mycobot_moveit_config/config',
        robot_name
    ))
    print(f"src_config_path: {src_config_path}")

    install_config_path = os.path.abspath(os.path.join(
        home,
        'Documents/workspace_mycobot/install/mycobot_moveit_config/share/mycobot_moveit_config/config',
        robot_name
    ))
    print(f"install_config_path: {install_config_path}")
